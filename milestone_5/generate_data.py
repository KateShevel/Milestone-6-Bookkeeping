...
def generate_employee():
    ...
    month_names = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October',
                   'November', 'December']
    month_name = month_names[birthday.month - 1]  # Subtract 1 to match index
...
def write_to_csv(filename, data):
    with open(filename, 'w', newline='') as file:
        fieldnames = ['Name', 'Hiring Date', 'Department', 'Birthday', 'Month',
                      'Anniversary']  # Include specified fields
...
def main():
    employee_data = []
    for _ in range(100):  # Generate information for 100 employees
